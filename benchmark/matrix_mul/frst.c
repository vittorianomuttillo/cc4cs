...
void matrix_mul(TARGET_INDEX row_num_a, TARGET_INDEX column_num_a, TARGET_TYPE a[row_num_a][column_num_a], TARGET_INDEX row_num_b, TARGET_INDEX column_num_b, TARGET_TYPE b[row_num_b][column_num_b], TARGET_TYPE c, TARGET_TYPE d, TARGET_TYPE res[row_num_a][column_num_b])
{
	TARGET_INDEX i; 
	TARGET_INDEX j;
	TARGET_INDEX k = 0;
